...
$('.home-banner').mousemove(function(e) {
  ...
  * ============================================*/
    ...
    if ($(".rev-slider").length) {
        ...
        $("#rev_slider_mobile_1_5").show().revolution({
            sliderType: "standard",
            jsFileLocation: "//localhost/reveditor/revslider/public/assets/js/",
            sliderLayout: "fullscreen",
            dottedOverlay: "none",
...
$(document).ready(function() {
    ...
    $('.custom-next').click(function() {
        $('.list-item-slider').trigger('next.owl.carousel');
    });

    $('.custom-prev').click(function() {
        $('.list-item-slider').trigger('prev.owl.carousel');
    });
});
...
window.addEventListener('DOMContentLoaded', (event) => {
    setTimeout(function(){
        ...
        btn.style.opacity = "0";
        btn.style.animationName = "fadeInUp";
